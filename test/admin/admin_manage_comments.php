...
$maxRows_rs_questions_comments = 10;
$pageNum_rs_questions_comments = 0;
if (isset($_GET['pageNum_rs_questions_comments'])) {
  $pageNum_rs_questions_comments = $_GET['pageNum_rs_questions_comments'];
}
$startRow_rs_questions_comments = $pageNum_rs_questions_comments * $maxRows_rs_questions_comments;

mysql_select_db($database_BlogConnection, $BlogConnection);
$query_rs_questions_comments = "SELECT * FROM blog_questions_comments";
$query_limit_rs_questions_comments = sprintf("%s LIMIT %d, %d", $query_rs_questions_comments, $startRow_rs_questions_comments, $maxRows_rs_questions_comments);
$rs_questions_comments = mysql_query($query_limit_rs_questions_comments, $BlogConnection) or die(mysql_error());
$row_rs_questions_comments = mysql_fetch_assoc($rs_questions_comments);

if (isset($_GET['totalRows_rs_questions_comments'])) {
  $totalRows_rs_questions_comments = $_GET['totalRows_rs_questions_comments'];
} else {
  $all_rs_questions_comments = mysql_query($query_rs_questions_comments);
  $totalRows_rs_questions_comments = mysql_num_rows($all_rs_questions_comments);
}
$totalPages_rs_questions_comments = ceil($totalRows_rs_questions_comments/$maxRows_rs_questions_comments)-1;

$colname_rs_question_comment_to_modify = "9";
...
<table width="90%" border="0" cellpadding="1" cellspacing="1">
  <?php do { ?>
      <tr>
        ...
        <td width="20%" valign="middle" align="center"><a align="center" href="admin_manage_comments?id_question_comment=<?php echo $row_rs_questions_comments['id_question_comment']; ?>"><img src="../../images/update.gif"/></a></td>
      ...
      <td width="20%"><?php echo $row_rs_questions_comments['last_name']; ?></td>
