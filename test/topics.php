...
mysql_select_db($database_BlogConnection, $BlogConnection);
$query_rsArticles = sprintf("SELECT * FROM blog_articles INNER JOIN blog_topics ON id_topic_article=id_topic WHERE id_topic_article = %s ORDER BY date_article DESC", GetSQLValueString($colname_rsArticles, "int"));
...
<!-- InstanceBeginEditable name="edit_area_column_2" -->
 ...
 <div class="col3">
      <div class="content">
        <h2 class="tagLine">Articles tagged &quot;<?php echo $row_rsArticles['title_topic']; ?>&quot;</h2>
      </div>
