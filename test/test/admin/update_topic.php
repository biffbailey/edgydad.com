...
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
  <table align="center">
    <tr valign="baseline">
      ...
      <td><input type="text" name="title_topic" value="<?php echo htmlentities($row_rsTopic_to_Update['title_topic'], ENT_COMPAT, 'utf-8'); ?>" size="69" /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Description_topic:</td>
      <td><textarea name="description_topic" cols="32" rows="4"><?php echo htmlentities($row_rsTopic_to_Update['description_topic'], ENT_COMPAT, 'utf-8'); ?></textarea></td>
    </tr>
    <tr valign="baseline">
