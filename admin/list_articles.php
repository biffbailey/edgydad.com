...
mysql_select_db($database_BlogConnection, $BlogConnection);
$query_rsAdminArticles = "SELECT * FROM blog_articles INNER JOIN blog_topics ON id_topic_article=id_topic ORDER BY date_article DESC";
$rsAdminArticles = mysql_query($query_rsAdminArticles, $BlogConnection) or die(mysql_error());
$row_rsAdminArticles = mysql_fetch_assoc($rsAdminArticles);
$totalRows_rsAdminArticles = mysql_num_rows($rsAdminArticles);
?>
...
<title>EdgyDad's Blog Admin Article List</title>
...
<div class="col3">
	...
	<!-- InstanceBeginEditable name="edit_column_3_main_content" -->
      ...
      <div class="content">
        <h2 class="tagLine">Administrative Article List:</h2>
      </div>
      <p></p>
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
        <?php do { ?>
        <tr>
          <td><?php echo $row_rsAdminArticles['title_topic']; ?> &gt; <?php echo $row_rsAdminArticles['title_article']; ?></td>
          <td>Updated: <?php echo $row_rsAdminArticles['date_article']; ?></td>
          <td align="center" valign="middle"><a href="update_article.php?id_article=<?php echo $row_rsAdminArticles['id_article']; ?>"><img src="../images/update.gif" alt="Update_Article" width="23" height="23" hspace="0" vspace="0" align="absmiddle" /></a></td>
          <td align="center" valign="middle"><a href="delete_article.php?id_article=<?php echo $row_rsAdminArticles['id_article']; ?>"><img src="../images/delete.gif" alt="Delete_Article" width="23" height="23" hspace="0" vspace="0" align="absmiddle" /></a></td>
        </tr>
        
          <tr>
            <td colspan="5"><p><?php echo $row_rsAdminArticles['description_article']; ?></p>
              <hr />
            <p>&nbsp;</p></td>
          </tr>
        <?php } while ($row_rsAdminArticles = mysql_fetch_assoc($rsAdminArticles)); ?>
      </table>
<p>&nbsp;</p>
...
mysql_free_result($rsAdminArticles);
?>
