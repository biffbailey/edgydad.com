...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO coffee_green (id_coffee, name_coffee, vendor_coffee, description_coffee, price_coffee, comment_coffee, date_coffee, weblink_vendor_coffee) VALUES (%s, %s, %s, %s, %s, %s, %s, %s)",
                       GetSQLValueString($_POST['id_coffee'], "int"),
                       GetSQLValueString($_POST['name_coffee'], "text"),
                       GetSQLValueString($_POST['vendor_coffee'], "text"),
                       GetSQLValueString($_POST['description_coffee'], "text"),
                       GetSQLValueString($_POST['price_coffee'], "text"),
                       GetSQLValueString($_POST['comment_coffee'], "text"),
                       GetSQLValueString($_POST['date_coffee'], "date"),
                       GetSQLValueString($_POST['weblink_vendor_coffee'], "text"));

  mysql_select_db($database_BlogConnection, $BlogConnection);
  $Result1 = mysql_query($insertSQL, $BlogConnection) or die(mysql_error());

  $insertGoTo = "coffee_log.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
<title>EdgyDad's Blog Admin Post Coffee</title>
...
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
  <table align="center">
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Name_coffee:</td>
      <td><input type="text" name="name_coffee" value="" size="32" /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Vendor_coffee:</td>
      <td><input type="text" name="vendor_coffee" value="" size="32" /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Description_coffee:</td>
      <td><input type="text" name="description_coffee" value="" size="32" /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Price_coffee:</td>
      <td><input type="text" name="price_coffee" value="" size="32" /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Comment_coffee:</td>
      <td><textarea name="comment_coffee" cols="32" rows="3"></textarea></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Date_coffee:</td>
      <td><input type="text" name="date_coffee" value="" size="32" /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Weblink_vendor_coffee:</td>
      <td><input type="text" name="weblink_vendor_coffee" value="" size="32" /></td>
    </tr>
    <tr valign="baseline">
