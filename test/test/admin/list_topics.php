...
<title>EdgyDad's Blog Admin Topic List</title>
...
<div class="col3">
    ...
    <div class="col3">
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
        <tr>
              <td width="30%" align="center" valign="middle"><h4>Topic</h4></td>
              <td width="60%" align="center" valign="middle"><h4>Description</h4></td>
        </tr>
      </table>
	  <?php do { ?>
	  <table width="100%" border="0" cellpadding="0" cellspacing="0">
	    <tr>
	      <td width="30%"><?php echo $row_rsTopicList['title_topic']; ?></td>
	      <td width="60%"><?php echo $row_rsTopicList['description_topic']; ?></td>
	      <td width="10%" align="center" valign="middle"><a href="update_topic.php?id_topic=<?php echo $row_rsTopicList['id_topic']; ?>"><img src="../Images/update.gif" "alt"="update_topic" width="23" height="23" hspace="0" vspace="0" align="absmiddle" /></a></td>
        </tr>
	    <tr>
	      <td colspan="3"><hr /></td>
        </tr>
