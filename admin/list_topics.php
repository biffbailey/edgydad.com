...
<table border="1" bordercolor="#eeb702" cellpadding="1" cellspacing="1" width="99%" align="center">
  <tr>
    <td width="10%" align="center">ID_Topic</td>
    <td width="70%" align="center">Title_Topic</td>
  ...
  <?php do { ?>
    <tr>
      ...
      <td><a href="delete_topic.php?id_topic=<?php echo $row_rsTopics_2['id_topic']; ?>"><img src="../images/update.gif" width="23" height="23" align="left" alt="update_button"><img src="../images/delete.gif" alt="Delete Topic" width="23" height="23" align="right" /></a></td>
    </tr>
