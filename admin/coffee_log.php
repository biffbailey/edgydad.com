...
mysql_select_db($database_BlogConnection, $BlogConnection);
$query_rs_green_coffee = "SELECT * FROM coffee_green";
$rs_green_coffee = mysql_query($query_rs_green_coffee, $BlogConnection) or die(mysql_error());
$row_rs_green_coffee = mysql_fetch_assoc($rs_green_coffee);
$totalRows_rs_green_coffee = mysql_num_rows($rs_green_coffee);
?>
...
<title>EdgyDad's Admin Manage Green Coffee Log</title>
...
<h1>Green Coffee Log</h1>
<table width="100%" border="1" cellpadding="1" cellspacing="1">
  <tr>
    <td colspan="3">Coffee Name</td>
    </tr>
  <tr>
    <td width="70%">Vendor</td>
    <td width="10%">Price per pound</td>
    <td width="20%">Date</td>
    </tr>
  <tr>
...
<table width="100%" border="0" cellpadding="1" cellspacing="1">
  <?php do { ?>
      <tr>
        <td colspan="2"><?php echo $row_rs_green_coffee['name_coffee']; ?></td>
        <td><a href="update_coffee.php?id_coffee=<?php echo $row_rs_green_coffee['id_coffee']; ?>"><img src="../images/update.gif" width="23" height="23" hspace="5" alt="Update Record" /></a><a href="delete_coffee.php?id_coffee=<?php echo $row_rs_green_coffee['id_coffee']; ?>"><img src="../images/delete.gif" width="23" height="23" hspace="5" alt="Delete Record" /></a></td>
        </tr>
      <tr>
      <td width="70%"><a href="<?php echo $row_rs_green_coffee['weblink_vendor_coffee']; ?>"><?php echo $row_rs_green_coffee['vendor_coffee']; ?></a></td>
      <td width="10%"><?php echo $row_rs_green_coffee['price_coffee']; ?></td>
      <td width="20%"><?php echo $row_rs_green_coffee['date_coffee']; ?></td>
      </tr>
    <tr>
      <td colspan="3"><?php echo $row_rs_green_coffee['description_coffee']; ?></td>
      </tr>
    <tr>
      <td colspan="3"><?php echo $row_rs_green_coffee['comment_coffee']; ?>
        <hr /></td>
      </tr>
    <?php } while ($row_rs_green_coffee = mysql_fetch_assoc($rs_green_coffee)); ?>
</table>
<!-- InstanceEndEditable -->
...
mysql_free_result($rs_green_coffee);
?>
