...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO blog_topics (title_topic, description_topic) VALUES (%s, %s)",
...
<div class="content">
  <h2 class="tagLine">Add Topic Form:</h2>
</div>
...
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
  <table align="center">
    <tr valign="baseline">
      ...
      <td><input type="text" name="title_topic" size="69" /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Description_topic:</td>
      <td><textarea name="description_topic" cols="32"></textarea></td>
    </tr>
    <tr valign="baseline">
