...
<!-- INSERT SPECIAL MENU ITEMS HERE IN 100% WIDTH TABLE BORDER 0-->
...
<!-- InstanceEndEditable -->
	...
	<!-- InstanceBeginEditable name="edit_column_3_main_content" -->
      <div class="content">
        <h2 class="tagLine">Biff's Clients and Customers</h2>
      </div>
      <div>
        <div>
          <table>
            <tbody>
              <tr>
                <td valign="top"><h3><strong>Clients, Customers and Public Agencies Biff Bailey has done Business with:</strong></h3>
                  <table cellpadding="2" cellspacing="5">
                    <tbody>
                      <tr>
                        <td valign="top"><p><u><strong>Clients and Employers</strong></u></p>
                          <ul>
                            <li>Friendswood Development Co., Houston, TX</li>
                            <li>Exxon Company, USA, Land Department, Houston, TX</li>
                            <li>Robert E. Brown and Company, Santa Monica, CA</li>
                            <li>Santa Monica Home Ownership Company, Santa Monica, CA
                              <ul>
                                <li>Moss Property Company, Ventura, CA</li>
                                <li>The Signature Group, Los Angeles, CA</li>
                                <li>837 10th Street, LP, Santa Monica, CA</li>
                              </ul>
                              <ul>
                                <li>Stephen Bickel, MD</li>
                              </ul>
                            </li>
                            <li>David Weekley Homes, Dallas, TX</li>
                            <li>3700 Commerce St. Lofts, Dallas, TX
                              <ul>
                                <li>TKM Construction, Dallas, TX</li>
                                <li>Tom Motlow</li>
                              </ul>
                            </li>
                            <li>Wilbow Development Corporation, Dallas, TX
                              <ul>
                                <li>Chas Fitzgerald</li>
                              </ul>
                            </li>
                            <li>4400 Elm Street Partners, Dallas, TX</li>
                            <li>Johnny Chen, Plano, TX</li>
                          </ul></td>
                        <td valign="top"><p><u><strong>Cities and Public Agencies</strong></u></p>
                          <ul>
                            <li>City of Nampa, ID</li>
                            <li>City of San Jose, CA</li>
                            <li>City of Houston, TX</li>
                            <li>City of Dallas, TX</li>
                            <li>City of McKinney, TX</li>
                            <li>City of Frisco, TX</li>
                            <li>City of Bedford, TX</li>
                            <li>Town of Flower Mound</li>
                            <li>City of Fort Worth, TX</li>
                            <li>Texas Commission on Environmental Quality</li>
                          </ul></td>
                        <td valign="top"><p><u><strong>Home Building Partners, JV Partners, Lot Sellers</strong></u></p>
                          <ul>
                            <li>Highland Homes, Dallas, TX</li>
                            <li>Goodman / K Hovnanian Homes, Dallas, TX</li>
                            <li>Drees Custom Homes, Dallas, TX</li>
                            <li>McGuyer Homebuilders, Inc (MHI) Dallas, TX</li>
                            <li>Ryland Homes</li>
                            <li>Grand Homes</li>
                            <li>Toll Brothers Homes</li>
                            <li>Landstar Homes</li>
                            <li>Darling Homes</li>
                            <li>Paul Taylor Homes</li>
                            <li>Morrison Homes</li>
                            <li>Ashton Woods Homes</li>
                          </ul>
                          <p><u><strong>Financial Partners</strong></u></p>
                          <ul>
                            <li>Union Bank, Santa Monica, CA</li>
                            <li>Signature Group, Los Angeles, CA</li>
                            <li>Butterfield &amp; Mason, Beverly Hills, CA</li>
                            <li>Gerald N. Davis, MD, FACS</li>
                            <li>Stephen Bickel, MD</li>
                          </ul></td>
                        <td valign="top"><p><u><strong>Lot Developers</strong></u></p>
                          <ul>
                            <li>Hillwood Residential, Dallas, TX</li>
                            <li>James R Harris Partners, Ft. Worth, TX</li>
                            <li>Herzog Development Corporation, Dallas, TX</li>
                            <li>Provident Realty</li>
                            <li>Blackard Development</li>
                            <li>Wilbow Property Corporation</li>
                            <li>Skorburg Company</li>
                            <li>Talmadge Tinsley</li>
                            <li>Marlin Atlantis</li>
                            <li>James M Brown Partners</li>
                            <li>Mathews Southwest</li>
                            <li>Hanover Property Company</li>
                            <li>Dickerson Development</li>
                            <li>Arcadia Realty</li>
                            <li>Wynn-Jackson</li>
                            <li>Mady Development</li>
                            <li>Warren Clark Development Company</li>
                            <li>Institutional Housing Partners</li>
                            <li>Stonebridge Ranch</li>
                            <li>Republic Property Group</li>
                            <li>Rusty Nichols</li>
                            <li>Steve Parsons</li>
                            <li>Forestar Real Estate Group</li>
                            <li>Henry S Miller Development</li>
                            <li>Sepiela Interests</li>
                            <li>Huffines Companies</li>
                            <li>Kent Donahue, Richard Cronin</li>
                          </ul></td>
                        <td valign="top"><p><u><strong>Land Buyers, Lessees</strong></u><br />
                        </p>
                          <ul>
                            <li>Abbott Laboratories</li>
                            <li>McDonnell Douglas Real Estate</li>
                            <li>Prentiss Properties</li>
                            <li>Metro Airlines, Houston, TX</li>
                            <li>Amalang Partners, Houston, TX</li>
                            <li>McCord Properties</li>
                            <li>Stone's Gym</li>
                            <li>Clear Creek ISD</li>
                            <li>Bill Lannigan</li>
                            <li>Griffin / Juban Partners, Houston, TX</li>
                            <li>Houston Metropolitan Transit Authority</li>
                            <li>Westinghouse Corp.</li>
                            <li>Nica Chemical Company, Japan</li>
                            <li>Pennington Chen Realty</li>
                            <li>Ned Dudney, MD</li>
                            <li>Clear Lake National Bank</li>
                          </ul></td>
                      </tr>
                    </tbody>
                  </table>
