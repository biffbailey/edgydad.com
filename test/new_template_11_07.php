...
<!-- InstanceBeginEditable name="edit_area_column_2" -->
 ...
 <!-- InstanceEndEditable -->
	...
	<!-- InstanceBeginEditable name="edit_column_3_main_content" -->
      ...
      <p>Welcome to EdgyDad's Blog, hosted at biffbailey.com. Below is a list of recent articles. Choose a topic from the list in the column to the left to see to a list of articles related to that topic.</p>
