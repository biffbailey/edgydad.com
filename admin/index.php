...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO blog_articles (id_topic_article, id_topic_article_2, id_topic_article_3, tags_article, title_article, description_article, text_article, date_article) VALUES (%s, %s, %s, %s, %s, %s, %s, %s)",
                       GetSQLValueString($_POST['id_topic_article'], "int"),
                       GetSQLValueString($_POST['id_topic_article_2'], "int"),
                       GetSQLValueString($_POST['id_topic_article_3'], "int"),
                       GetSQLValueString($_POST['tags_article_2'], "text"),
...
mysql_select_db($database_BlogConnection, $BlogConnection);
$query_rsTopicList = "SELECT * FROM blog_topics ORDER BY title_topic ASC";
    ...
    <div class="col3">
      ...
      <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
        <table align="center">
          ...
          <tr valign="baseline">
            <td nowrap="nowrap" align="right" valign="top">Id_article_Topic_2:</td>
            <td><select name="id_topic_article_2" id="id_topic_article_2">
              <?php
do {  
?>
              <option value="<?php echo $row_rsTopicList['id_topic']?>"><?php echo $row_rsTopicList['title_topic']?></option>
              <?php
} while ($row_rsTopicList = mysql_fetch_assoc($rsTopicList));
  $rows = mysql_num_rows($rsTopicList);
  if($rows > 0) {
      mysql_data_seek($rsTopicList, 0);
	  $row_rsTopicList = mysql_fetch_assoc($rsTopicList);
...
?>
          ...
          <tr valign="baseline">
            <td nowrap="nowrap" align="right" valign="top">Id_article_Topic_3:</td>
            <td><select name="id_topic_article_3" id="id_topic_article3">
              <?php
do {  
?>
              <option value="<?php echo $row_rsTopicList['id_topic']?>"><?php echo $row_rsTopicList['title_topic']?></option>
...
?>
          ...
          <tr valign="baseline">
            <td nowrap="nowrap" align="right" valign="top">Tags_article</td>
            <td><textarea name="tags_article_2" cols="50" rows="2" id="tags_article_2"></textarea></td>
          </tr>
          <tr valign="baseline">
            <td nowrap="nowrap" align="right" valign="top">Description_article:</td>
            <td><span id="sprytextarea1">
            <textarea name="description_article" cols="50" rows="2"></textarea>
            <span class="textareaRequiredMsg">A value is required.</span><span id="countsprytextarea1">&nbsp;</span></span></td>
          </tr>
          <tr valign="baseline">
            <td nowrap="nowrap" align="right" valign="top">Text_article:</td>
            <td><textarea name="text_article" cols="50" rows="10"></textarea></td>
          </tr>
          <tr valign="baseline">
