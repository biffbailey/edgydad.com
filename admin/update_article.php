...
<a href="#" class="adSpotLarge"><img src="/images/Building_Creds.jpg" alt="ad2" width="100%" /></a></a> 
  ...
  <h2 class="tagLine">Update Article Form:</h2>
   ...
   <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
     <table align="center">
       ...
       <tr valign="baseline">
         <td nowrap="nowrap" align="right">Id_topic_article:</td>
         <td><select name="id_topic_article_list_input" id="id_topic_article_list_input">
           <?php
do {  
?>
           <option value="<?php echo $row_rsTopicList['id_topic']?>"<?php if (!(strcmp($row_rsTopicList['id_topic'], $row_rsArticle_to_Update['id_topic_article']))) {echo "selected=\"selected\"";} ?>><?php echo $row_rsTopicList['title_topic']?></option>
           <?php
...
?>
       ...
       <tr valign="baseline">
         ...
         <td>
           ...
           <textarea name="description_article" cols="32"><?php echo htmlentities($row_rsArticle_to_Update['description_article'], ENT_COMPAT, 'utf-8'); ?></textarea>
